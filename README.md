...
1. [Extract, transform, and load]([https://github.com/seyed-nouraie/Azure-Security-Data-Lake/tree/main/DataSources](https://github.com/seyed-nouraie/Azure-Data-Lake-ETL/tree/main/Nifi) logging data into ADLS.  Transforms include structure formatting and parquet output.
